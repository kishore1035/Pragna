...
GENERAL_SYSTEM_PROMPT = (
    ...
    "MANDATORY MIMIR OUTPUT STRUCTURE RULES:\n"
    ...
    "4. CODE & ARTIFACTS: When asked for code, output clean code directly. For complete standalone files or interactive HTML, use the artifact convention: ```artifact title=\"...\" language=\"...\"```. For snippets, use standard markdown fences.\n"
